...
import kotlinx.android.synthetic.main.proximity_fragment_proximity.*
import timber.log.Timber

class ProximityFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = ProximityAdapter()
    private val errorAdapter = ErrorAdapter(R.string.proximity_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.proximity_fragment_proximity, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): ProximityFragment = ProximityFragment()
    }
