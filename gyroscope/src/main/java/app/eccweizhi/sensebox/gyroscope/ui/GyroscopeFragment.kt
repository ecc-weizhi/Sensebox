...
import kotlinx.android.synthetic.main.gyroscope_fragment_gyroscope.*
import timber.log.Timber

class GyroscopeFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = GyroscopeAdapter()
    private val errorAdapter = ErrorAdapter(R.string.gyroscope_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.gyroscope_fragment_gyroscope, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): GyroscopeFragment = GyroscopeFragment()
    }
