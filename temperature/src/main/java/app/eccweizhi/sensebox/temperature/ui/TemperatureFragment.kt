...
import kotlinx.android.synthetic.main.temperature_fragment_temperature.*
import timber.log.Timber

class TemperatureFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = TemperatureAdapter()
    private val errorAdapter = ErrorAdapter(R.string.temperature_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.temperature_fragment_temperature, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): TemperatureFragment = TemperatureFragment()
    }
