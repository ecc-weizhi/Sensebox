...
import kotlinx.android.synthetic.main.pressure_fragment_pressure.*
import timber.log.Timber

class PressureFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = PressureAdapter()
    private val errorAdapter = ErrorAdapter(R.string.pressure_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.pressure_fragment_pressure, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): PressureFragment = PressureFragment()
    }
