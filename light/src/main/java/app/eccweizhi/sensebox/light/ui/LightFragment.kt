...
import kotlinx.android.synthetic.main.light_fragment_light.*
import timber.log.Timber

class LightFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = LightAdapter()
    private val errorAdapter = ErrorAdapter(R.string.light_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.light_fragment_light, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): LightFragment = LightFragment()
    }
