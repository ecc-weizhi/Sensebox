...
import kotlinx.android.synthetic.main.rotationvector_fragment_rotation_vector.*
import timber.log.Timber

class RotationVectorFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = RotationVectorAdapter()
    private val errorAdapter = ErrorAdapter(R.string.rotationvector_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.rotationvector_fragment_rotation_vector, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): RotationVectorFragment = RotationVectorFragment()
    }
