package app.eccweizhi.sensebox.linearacceleration.ui
...
import app.eccweizhi.sensebox.linearacceleration.model.RawDataModel
import kotlinx.android.synthetic.main.linearacceleration_fragment_linear_acceleration.*
import timber.log.Timber

class LinearAccelerationFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = LinearAccelerationAdapter()
    private val errorAdapter = ErrorAdapter(R.string.linearacceleration_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.linearacceleration_fragment_linear_acceleration,
            container,
            false
        )
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): LinearAccelerationFragment = LinearAccelerationFragment()
    }
