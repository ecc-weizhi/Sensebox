...
class GravityAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            R.layout.gravity_item_raw_data -> {
                RawDataVh(itemView)
            }
    ...
    override fun onBindViewHolder(
        ...
        when (holder) {
            is PageTitleVh -> {
                holder.bindData(R.string.gravity_display_name)
            }
            is RawDataVh -> {
    ...
    override fun getItemViewType(position: Int): Int {
        return when (position) {
            ...
            POSITION_RAW_DATA -> R.layout.gravity_item_raw_data
