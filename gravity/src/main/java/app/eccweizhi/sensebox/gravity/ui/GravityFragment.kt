...
import kotlinx.android.synthetic.main.gravity_fragment_gravity.*
import timber.log.Timber

class GravityFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = GravityAdapter()
    private val errorAdapter = ErrorAdapter(R.string.gravity_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.gravity_fragment_gravity, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): GravityFragment = GravityFragment()
    }
