...
import kotlinx.android.synthetic.main.magneticfield_fragment_magnetic_field.*
import timber.log.Timber

class MagneticFieldFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = MagneticFieldAdapter()
    private val errorAdapter = ErrorAdapter(R.string.magneticfield_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.magneticfield_fragment_magnetic_field, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): MagneticFieldFragment = MagneticFieldFragment()
    }
