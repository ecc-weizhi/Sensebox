package app.eccweizhi.sensebox.ambienttemperature.ui
...
import kotlinx.android.synthetic.main.ambienttemperature_fragment_ambient_temperature.*
import timber.log.Timber

class AmbientTemperatureFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = AmbientTemperatureAdapter()
    private val errorAdapter = ErrorAdapter(R.string.ambienttemperature_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.ambienttemperature_fragment_ambient_temperature,
            container,
            false
        )
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): AmbientTemperatureFragment = AmbientTemperatureFragment()
    }
