...
import kotlinx.android.synthetic.main.orientation_fragment_orientation.*
import timber.log.Timber

class OrientationFragment : Fragment() {
    private var listener: FragmentListener? = null
    private val adapter = OrientationAdapter()
    private val errorAdapter = ErrorAdapter(R.string.orientation_display_name)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.orientation_fragment_orientation, container, false)
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): OrientationFragment = OrientationFragment()
    }
